 ...
 * This implementation is not my own, it was sourced from the article below
 * I went with this because it is very intuitive and simple
 * @see https://www.alexedwards.net/blog/implementing-an-in-memory-cache-in-go
 */
